...
function crearDiv(){
    var caja=document.createElement("div"); //comentario 1
    return caja;
}
function over1(){
    over(cuadro1);
...
function click1(){
    cuadro1.elegido=!cuadro1.elegido;               //es un interruptor, hace false a true y true a false
    click(cuadro1);
}
function click2(){
     cuadro2.elegido=!cuadro2.elegido;               //es un interruptor, hace false a true y true a false
    click(cuadro2);
}
function click3(){
    cuadro3.elegido=!cuadro3.elegido;               //es un interruptor, hace false a true y true a false
    click(cuadro3);
}
...
function FichaS(){
   ...
   this.caja.style.background= "#0088CC";
...
function FichaM(){
    ...
    this.caja.style.height=altura;
    this.caja.style.background= "#979797";
    this.caja.style.marginLeft="auto";
    this.caja.style.marginRight="auto";
    this.valor=1;
 }
 function FichaL(){
    ...
    this.caja.style.height=altura;
    this.caja.style.background= "#666666";
    this.caja.style.marginLeft="auto";
    this.caja.style.marginRight="auto";
    this.valor=2;
 }
 function FichaXL(){
    ...
    this.caja.style.height=altura;
    this.caja.style.background= "#000000";
    this.caja.style.marginLeft="auto";
    this.caja.style.marginRight="auto";
    this.valor=3;
 }
